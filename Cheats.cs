...
namespace GarouToremo
{
    class Cheats
    {
        ...
        public const int POSITION_X_MIN             = 36;
        public const int POSITION_X_MAX             = 604;
        public const int POSITION_X_CENTER_SCENARIO = 160;
        public const int POSITION_X_MIN_SCENARIO    = 0;
        public const int POSITION_X_MAX_SCENARIO    = 320;
        ...
        public int[] GetScenarioPosition(Player p2)
        {
            int x = garouMem.Read2Byte(ADDRESS_SCENARIO_X);
            int y = garouMem.Read2Byte(ADDRESS_SCENARIO_X);
